Current fluids simulation implemention uses Smoothed Particle Hydrodynamics (SPH) algorithm, with implementation based on https://lucasschuermann.com/writing/implementing-sph-in-2d.
